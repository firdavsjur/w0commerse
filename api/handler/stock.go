...
// @Accept json
// @Produce json
// @Param stock body models.Stock true "CreateStockRequest"
...
func (h *Handler) CreateStock(c *gin.Context) {
	...
	resp, err := h.storages.Stock().GetByID(context.Background(), &models.GetByIDStockRequest{StoreID: id})
	if err != nil {
...
func (h *Handler) GetByIdStock(c *gin.Context) {
	...
	resp, err := h.storages.Stock().GetByID(context.Background(), &models.GetByIDStockRequest{StoreID: idInt})
	if err != nil {
		h.handlerResponse(c, "storage.stock.getByID", http.StatusInternalServerError, err.Error())
		return
	}
...
// @Produce json
// @Param id path string true "id"
// @Param stock body models.Stock true "UpdateStockRequest"
...
// @Produce json
// @Param id path string true "id"
// @Param stock body models.GetByIDStockRequest true "DeleteStockRequest"
...
func (h *Handler) DeleteStock(c *gin.Context) {
	...
	rowsAffected, err := h.storages.Stock().Delete(context.Background(), &models.GetByIDStockRequest{StoreID: idInt})
	if err != nil {
